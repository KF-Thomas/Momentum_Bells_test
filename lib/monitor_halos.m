...
top_halo.g2 = 2 + 1./top_halo.m;
            ...
            halo_history.m=[halo_history.m,top_halo.m];
            halo_history.g2=[halo_history.g2,top_halo.g2];
            ...
            if numel(halo_history.shot_num)>anal_opts.history.shots
                ...
                halo_history.m=halo_history.m(end-anal_opts.history.shots:end);
                halo_history.g2=halo_history.g2(end-anal_opts.history.shots:end);
            end
