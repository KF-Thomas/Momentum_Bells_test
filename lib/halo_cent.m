...
[bec.centre_top,bec.width_top,bec.counts_top,bec.centre_OK_top] =  find_dist_cen(data,opts_cent);%find_dist_cen(data,opts_cent.top)
opts_cent.mid.crop = [opts_cent.t_bounds{2}; -0.022, 0.011; -0.08, 0.018];
[bec.centre_mid,bec.width_mid,bec.counts_mid,bec.centre_OK_mid] =  find_dist_cen(data,opts_cent);%find_dist_cen(data,opts_cent.mid)
opts_cent.btm.crop = [opts_cent.t_bounds{1}; -0.022, 0.011; -0.08, 0.018];
[bec.centre_btm,bec.width_btm,bec.counts_btm,bec.centre_OK_btm] =  find_dist_cen(data,opts_cent);%find_dist_cen(data,opts_cent.btm)
