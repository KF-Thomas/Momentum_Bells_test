function output=squeezing_zones_filtered(halo_centered_cells, random_throw_away_perc_list, Nz_test)
...
%         + ", throwing away " + num2str(100*(1-rtap), 2) + "% of data " + '\n\n');
    ...
    output{irtapl} = {rtap, squeezing_zones(halo_centered_cells,true, Nz_test, rtap)};
end 
